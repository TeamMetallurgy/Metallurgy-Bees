...
import elcon.mods.metallurgybees.forestry.Metals.Metal;
...
public enum MetallurgyBeeTypes {
    ...
    DAMASCUS_STEEL("damascus Steel", new ColorPair(88, 63, 44, 65, 47, 33), new ColorPair(153, 109, 77, 88, 63, 44), new ColorPair(223, 205, 191, 153, 109, 77), new ColorPair(223, 205, 191, 153, 109, 77)),
    ...
    SHADOW_IRON("shadow Iron", new ColorPair(82, 62, 49, 56, 43, 33), new ColorPair(141, 117, 101, 82, 62, 49), new ColorPair(188, 171, 160, 141, 117, 101), new ColorPair(188, 171, 160, 82, 62, 49)),
    ...
    SHADOW_STEEL("shadow Steel", new ColorPair(97, 82, 69, 58, 50, 41), new ColorPair(136, 115, 98, 97, 82, 69), new ColorPair(235, 230, 226, 199, 185, 175), new ColorPair(199, 185, 175, 97, 82, 69)),
    ...
    DEEP_IRON("deep Iron", new ColorPair(73, 91, 105, 48, 61, 71), new ColorPair(121, 143, 162, 73, 91, 105), new ColorPair(167, 182, 194, 121, 143, 162), new ColorPair(167, 182, 194, 48, 61, 71)),
    ...
    BLACK_STEEL("black Steel", new ColorPair(57, 86, 121, 28, 41, 57), new ColorPair(155, 180, 208, 57, 86, 121), new ColorPair(220, 230, 239, 155, 180, 208), new ColorPair(220, 230, 239, 57, 86, 121)),
    ...
    ASTRAL_SILVER("astral Silver", new ColorPair(184, 202, 203, 105, 141, 143), new ColorPair(209, 221, 222, 184, 202, 203), new ColorPair(235, 241, 241, 209, 221, 222), new ColorPair(235, 241, 241, 184, 202, 203)),
